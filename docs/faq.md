...
To reduces the number of lines printed by the progress bar, you can increase the minimum interval between updates with the `TQDM_MININTERVAL` environment variable.
...
Please open an issue on the [GitHub repository](https://github.com/haddocking/protein-quest/issues).
